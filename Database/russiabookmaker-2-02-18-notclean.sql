...
-- Généré le :  Ven 02 Février 2018 à 16:41
...
(1, 1, 2, 'A', 1, 0, 0, NULL, NULL, 0, '2018-06-14 17:00:00', NULL, NULL),
(2, 3, 4, 'A', 2, 0, 0, NULL, NULL, 0, '2018-06-15 14:00:00', NULL, NULL),
...
CREATE TABLE `russia_team` (
  ...
  `flag_mobile` text COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `russia_team` (`id`, `name`, `smallname`, `flag`, `starplayer`, `group`, `previous`, `coach`, `points`, `flag_mobile`) VALUES
(1, 'Russie', 'RUS', 'images/flags/RUS.png', 'joueur star', 'A', 'lorem', 'coach', 0, 'images/flagsmobile/russie.png'),
(2, 'Arabie Saoudite', 'ASA', 'images/flags/ASA.png', 'joueur star', 'A', 'lorem', 'coach', 0, 'images/flagsmobile/arabiesaoudite.png'),
(3, 'Egypte', 'EGY', 'images/flags/EGY.png', 'joueur star', 'A', 'lorem', 'coach', 0, 'images/flagsmobile/egypte.png'),
(4, 'Uruguay', 'URU', 'images/flags/URU.png', 'joueur star', 'A', 'lorem', 'coach', 0, 'images/flagsmobile/uruguay.png'),
(5, 'Portugal', 'POR', 'images/flags/POR.png', 'joueur star', 'B', 'lorem', 'coach', 0, 'images/flagsmobile/portugal.png'),
(6, 'Espagne', 'ESP', 'images/flags/ESP.png', 'joueur star', 'B', 'lorem', 'coach', 0, 'images/flagsmobile/espagne.png'),
(7, 'Maroc', 'MAR', 'images/flags/MAR.png', 'joueur star', 'B', 'lorem', 'coach', 0, 'images/flagsmobile/maroc.png'),
(8, 'Iran', 'IRA', 'images/flags/IRA.png', 'joueur star', 'B', 'lorem', 'coach', 0, 'images/flagsmobile/iran.png'),
(9, 'France', 'FRA', 'images/flags/FRA.png', 'joueur star', 'C', 'lorem', 'coach', 0, 'images/flagsmobile/france.png'),
(10, 'Australie', 'AUS', 'images/flags/AUS.png', 'joueur star', 'C', 'lorem', 'coach', 0, 'images/flagsmobile/australie.png'),
(11, 'Pérou', 'PER', 'images/flags/PER.png', 'joueur star', 'C', 'lorem', 'coach', 0, 'images/flagsmobile/perou.png'),
(12, 'Danemark', 'DAN', 'images/flags/DAN.png', 'joueur star', 'C', 'lorem', 'coach', 0, 'images/flagsmobile/danemark.png'),
(13, 'Argentine', 'ARG', 'images/flags/ARG.png', 'joueur star', 'D', 'lorem', 'coach', 0, 'images/flagsmobile/argentine.png'),
(14, 'Islande', 'ISL', 'images/flags/ISL.png', 'joueur star', 'D', 'lorem', 'coach', 0, 'images/flagsmobile/islande.png'),
(15, 'Croatie', 'CRO', 'images/flags/CRO.png', 'joueur star', 'D', 'lorem', 'coach', 0, 'images/flagsmobile/croatie.png'),
(16, 'Nigéria', 'NIG', 'images/flags/NIG.png', 'joueur star', 'D', 'lorem', 'coach', 0, 'images/flagsmobile/nigeria.png'),
(17, 'Brésil', 'BRE', 'images/flags/BRE.png', 'joueur star', 'E', 'lorem', 'coach', 0, 'images/flagsmobile/bresil.png'),
(18, 'Suisse', 'SUI', 'images/flags/SUI.png', 'joueur star', 'E', 'lorem', 'coach', 0, 'images/flagsmobile/suisse.png'),
(19, 'Costa Rica', 'CRC', 'images/flags/CRC.png', 'joueur star', 'E', 'lorem', 'coach', 0, 'images/flagsmobile/costarica.png'),
(20, 'Serbie', 'SRB', 'images/flags/SRB.png', 'joueur star', 'E', 'lorem', 'coach', 0, 'images/flagsmobile/serbie.png'),
(21, 'Allemagne', 'ALL', 'images/flags/ALL.png', 'joueur star', 'F', 'lorem', 'coach', 0, 'images/flagsmobile/allemagne.png'),
(22, 'Mexique', 'MEX', 'images/flags/MEX.png', 'joueur star', 'F', 'lorem', 'coach', 0, 'images/flagsmobile/mexique.png'),
(23, 'Suède', 'SUE', 'images/flags/SUE.png', 'joueur star', 'F', 'lorem', 'coach', 0, 'images/flagsmobile/suede.png'),
(24, 'Corée', 'COR', 'images/flags/COR.png', 'joueur star', 'F', 'lorem', 'coach', 0, 'images/flagsmobile/coree.png'),
(25, 'Belgique', 'BEL', 'images/flags/BEL.png', 'joueur star', 'G', 'lorem', 'coach', 0, 'images/flagsmobile/belgique.png'),
(26, 'Panama', 'PAN', 'images/flags/PAN.png', 'joueur star', 'G', 'lorem', 'coach', 0, 'images/flagsmobile/panama.png'),
(27, 'Tunisie', 'TUN', 'images/flags/TUN.png', 'joueur star', 'G', 'lorem', 'coach', 0, 'images/flagsmobile/tunisia.png'),
(28, 'Angleterre', 'ANG', 'images/flags/ANG.png', 'joueur star', 'G', 'lorem', 'coach', 0, 'images/flagsmobile/angleterre.png'),
(29, 'Pologne', 'POL', 'images/flags/POL.png', 'joueur star', 'H', 'lorem', 'coach', 0, 'images/flagsmobile/pologne.png'),
(30, 'Sénégal', 'SEN', 'images/flags/SEN.png', 'joueur star', 'H', 'lorem', 'coach', 0, 'images/flagsmobile/senegal.png'),
(31, 'Colombie', 'COL', 'images/flags/COL.png', 'joueur star', 'H', 'lorem', 'coach', 0, 'images/flagsmobile/colombie.png'),
(32, 'Japon', 'JAP', 'images/flags/JAP.png', 'joueur star', 'H', 'lorem', 'coach', 0, 'images/flagsmobile/japon.png');
...
--
-- Contenu de la table `russia_top`
--

INSERT INTO `russia_top` (`id`, `username`, `team1`, `team2`, `team3`, `team4`) VALUES
(1, 'test', 'France', 'Argentine', 'Brésil', 'Belgique');
...
('Martine', '2be067b0de372807dc5e88c44897279e', 0, 1, 1),
('test', '098f6bcd4621d373cade4e832627b4f6', 0, 0, 1),
('testtesttt', '098f6bcd4621d373cade4e832627b4f6', 0, 0, 1);

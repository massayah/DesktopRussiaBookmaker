...
<p>En route pour la coupe du monde en Russie.</p>
...
<p class="mtl"><strong>OUBLI DE MOT DE PASSE</strong>&nbsp;: ne créez pas plein de comptes, ça ne sert à rien. <a href="contact.php">CONTACTEZ-NOUS</a> on vous le redonnera.</p>
</div><!--end connexion--> 
</div><!--end grid-2--> 
</div><!--end register-->
...
<ul id="rules">
<li><strong>Phase de poule</strong>&nbsp;: dans chaque groupe, chaque équipe rencontre les 3 autres équipes de son groupe.<br>victoire = 3 points<br>match nul = 1 point<br>défaite = 0 point<br>Les 2 équipes qui ont le plus de points accèdent aux 8èmes de finale.</li>
